...
define(function(require, exports, module) {
    require('jquery');
    require('cookie');
    var SessionKey111 = $.cookie('SessionKey');
	...
	$.fn.resizable = function(_57, _58) {
		...
		return this.each(function() {
			...
			function _65(e) {
				...
				var dir = "";
				var _68 = tt.offset();
				var _69 = tt.outerWidth() - 0 - 3;
				var _6a = tt.outerHeight() -0 + 20;
				var _6b = _63.edge;
...
(function($) {
	...
	function _3fe(_3ff, _400) {
		...
		_402._outerWidth(sb.width() - menu._outerWidth() - _401._outerWidth() - 38);	/*搜索框宽度问题 by：徐根福*/
		_402.css({
			height : sb.height() + "px",
